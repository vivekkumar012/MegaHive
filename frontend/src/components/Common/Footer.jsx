  ...
  return (
    <footer className="border-t py-12">
      <div className="container mx-auto grid grid-cols-1 md:grid-cols-4 gap-8 px-4 lg:px-0">
        ...
        <div>
            ...
            <div className="flex items-center gap-3">
                ...
                <a href="https://github.com/vivekkumar012" target="_blank" rel="noopener noreferrer" className="hover:text-gray-300">
      ...
      <div className="container mx-auto mt-12 px-4 lg:px-0 border-t border-gray-200 pt-6">
        <p className="text-gray-500 text-sm tracking-tighter text-center">c 2025, CompileTab. All Rights Reserver</p>
      </div>
    </footer>
  );
};
